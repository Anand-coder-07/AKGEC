...
# We'll create OAuth credentials via the Cloud Console
# First, let's check if client_secret.json exists
CLIENT_SECRET_FILE = os.path.join(os.path.dirname(__file__), 'client_secret.json')

if not os.path.exists(CLIENT_SECRET_FILE):
    print("=" * 60)
    print("STEP 1: Create OAuth Client ID")
    print("=" * 60)
    print()
    ...
    print("   - On 'Test users' page, add YOUR email")
